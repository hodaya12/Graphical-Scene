...
public class ShadowTest {
	 ...
	 */
	@Test
	public void SphereTriangleInitial() throws IOException {
	 ...
	 */
	@Test
	public void SphereTriangleMove1() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
	 ...
	 */
	@Test
	public void SphereTriangleMove2() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
	 ...
	 */
	@Test
	public void SphereTriangleSpot1() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
	 ...
	 */
	@Test
	public void SphereTriangleSpot2() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-73, 73, -58), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
	 ...
	 */
	@Test
	public void trianglesSphere() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
