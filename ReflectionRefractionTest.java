...
public class ReflectionRefractionTest {
	 ...
	 */
	@Test
	public void twoSpheres() throws IOException {
		...
		scene.addGeometries(
				new Sphere(new Color(java.awt.Color.BLUE), new Material(0.4, 0.3, 100, 0.3, 0), new Point3D(0, 0, 50),
						50),
	 ...
	 */
	@Test
	public void twoSpheresOnMirrors() throws IOException {
		Scene scene = new Scene("Test scene");
	 ...
	 */
	@Test
	public void trianglesTransparentSphere() throws IOException {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
